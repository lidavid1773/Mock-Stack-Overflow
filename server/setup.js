...
var qstnTable = require("./questionTable");
var ansTable = require("./ansTable");
var tagTable = require("./tagTable");
var qaTable = require("./qaTable");
var qtTable = require("./qtTable");
...
if (userArgs.length == 0) {
  ...
  console.log(
    "Correct Usage: node verify_schema -u <mysqlusername> -p <mysqlpassword>"
  );
  return;
}
    ...
    [
      function (callback) {
        qaTable.insert(
          connection,
          callback,
          entityIds[0].insertId,
          entityIds[2].insertId
        );
      },
      function (callback) {
        qaTable.insert(
      ...
      function (callback) {
        qaTable.insert(
          connection,
          callback,
          entityIds[1].insertId,
          entityIds[4].insertId
        );
      },
      function (callback) {
        qaTable.insert(
